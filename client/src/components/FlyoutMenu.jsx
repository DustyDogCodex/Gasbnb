function FlyoutMenu({ userInfo }) {
    //using userinfo to check if a user is logged in. Userinfo will be a blank object if no user is logged which will translate to a falsy value and vice versa
    return (
            ...
            <div className="w-screen max-w-md flex-auto overflow-hidden rounded-3xl bg-white text-sm leading-6 shadow-lg ring-1 ring-gray-900/5">
                <div className="p-4">
                    ...
                    <div className="group relative flex gap-x-6 rounded-lg p-4 hover:bg-gray-50">
                        <div>
                            <a 
                                href={ userInfo ? '/account' : '/register' } 
